...
test_dom:
	swipl --quiet -l test/domains.plt -t "run_tests"; done

test_base_op:
	swipl --quiet -l test/basic_operations.plt -t "run_tests"; done

test_intersec:
	swipl --quiet -l test/intersection.plt -t "run_tests"; done

test_reduc:
	swipl --quiet -l test/intersection.plt -t "run_tests"; done

test_label:
	swipl --quiet -l test/labeling.plt -t "run_tests"; done

test_dom_conv:
	swipl --quiet -l test/domain_conversion.plt -t "run_tests"; done
